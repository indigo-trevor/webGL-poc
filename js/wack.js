      ...
      "Installation"
		...
		init = function(parentId)
		{
			...
			for (var i = 0; i < moleCount; i++)
			{
				...
				// Create image
				var moleImg = $("<img></img>", {id: "Mole_"+i, class:'mole hidden', src:'img/wack/mole' + i + '.jpg'})
				...
				// Add the whack =)
				var whackImg = $("<img></img>", {id: "Whack_" + 1, class:'whack', src:"img/wack/whack.png"});
	  ...
	  update = function(step)
	  {
		for (var i=0; i<moleCount; i++)
		{
			...
			if (mole.timer <= 0)
			{
				if (mole.state == "dead")
				{
					$("#Mole_" + mole.id).attr("src", 'img/wack/mole' + getRandomInt(0, moleCount-1) + '.jpg');
					mole.state = "alive";
